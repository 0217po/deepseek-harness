  ...
  return (
    ...
    <div className={css.tabStrip} role="tablist" data-dockkit-strip={pane.id}
          ...
          return (
            <Fragment key={tabId}>
              ...
              >
                ...
                {closable && (
                  <Tooltip disabled={menu !== undefined} label={callbacks.labels.closeTabTooltip ?? callbacks.labels.closeTab} shortcutKeys={callbacks.labels.closeTabKeys} side="bottom" delayMs={500}>
                    <button
                      type="button"
      ...
      {!(callbacks.hideSplitWhenBlocked && block !== undefined) && (
        <Tooltip label={block === undefined ? callbacks.labels.splitPaneTooltip ?? callbacks.labels.splitPane : splitBlockedTitle(callbacks.labels, block)} shortcutKeys={callbacks.labels.splitPaneKeys} side="bottom" delayMs={500}>
          <span
