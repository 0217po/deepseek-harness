...
Menus use `Menu` or `MenuSurface`, including custom listboxes. Preserve the shared transparency and blur; only an explicit `material="solid"` with a local reason may omit blur ([rules](../../docs/web-styling.md#component-rules)).
