...
export const zh = {
  ...
  bundlesTitle: '已安装',
  officialTitle: '官方',
  builtinVoiceTitle: '语音输入',
  builtinVoiceDescription: '在本机使用 SenseVoice 转写录音；首次使用需安装依赖',
...
export const en = {
  ...
  builtinVoiceTitle: 'Voice input',
  builtinVoiceDescription: 'Transcribe recordings locally with SenseVoice; first use requires installing dependencies',
