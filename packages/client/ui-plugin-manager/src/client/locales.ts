...
export const zh = {
  ...
  installBackgroundUnconfirmed: '尚未确认安装已停止，可查看安装任务并重试取消。',
...
export const en = {
  ...
  installBackgroundUnconfirmed: 'Installation has not been confirmed stopped. View the installation to retry cancellation.',
