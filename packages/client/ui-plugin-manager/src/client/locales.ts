...
export const zh = {
  ...
  registryOfficial: '官方源（默认）',
  registryOfficialHint: 'registry.npmjs.org，遵循你本机的 pnpm 与 .npmrc 配置',
  registryNpmmirror: 'npmmirror',
  registryNpmmirrorBadge: '中国大陆网络推荐',
  registryNpmmirrorHint: 'registry.npmmirror.com，官方源的完整镜像，新发布的包最多延迟几分钟同步',
  ...
  registryFallbackNote: '选中的源连接失败时，会依次改用：{order}。GitHub 地址和 .tgz 直链本身不经过安装源，但它们的依赖仍从这里下载。',
  registryNoFallbackNote: '这个源连接失败时不会自动改用其他源。GitHub 地址和 .tgz 直链本身不经过安装源，但它们的依赖仍从这里下载。',
  ...
  installAttempt: '{previous} 连接失败，正在改用 {registry} 重试（第 {index} 个源，共 {total} 个）',
...
export const en = {
  ...
  registryOfficial: 'Official (default)',
  registryOfficialHint: 'registry.npmjs.org, following the pnpm and .npmrc configuration on this machine',
  registryNpmmirror: 'npmmirror',
  registryNpmmirrorBadge: 'Recommended in mainland China',
  registryNpmmirrorHint: 'registry.npmmirror.com, a complete mirror of the official registry; a newly published package can take a few minutes to arrive',
  ...
  registryFallbackNote: 'When the chosen registry cannot be reached, these are tried in turn: {order}. A GitHub address or a .tgz link is not fetched through the registry, but its dependencies are.',
  registryNoFallbackNote: 'When this registry cannot be reached, no other one is tried. A GitHub address or a .tgz link is not fetched through the registry, but its dependencies are.',
  registryListSeparator: ', ',
  installRun: 'Install',
  ...
  installAttempt: '{previous} could not be reached; retrying through {registry} (registry {index} of {total})',
