...
export const zh = {
  ...
  builtinAgentTeamDescription: '把一个任务交给一支团队：主智能体按需创建队友，成员之间发消息沟通、共同维护一块任务看板，各自认领工作；中途退出也不丢进度。',
  builtinAgentTeamWebTitle: '智能体团队 Web 界面',
  builtinAgentTeamWebDescription: '在浏览器里看团队干活：谁在忙、谁空闲一目了然，任务看板实时更新，点开任意成员就能进入它的会话。',
...
export const en = {
  ...
  builtinAgentTeamDescription: 'Hand a task to a team: the lead agent creates teammates as needed, members message each other and claim work on a shared task board, and progress survives even if someone drops off mid-way.',
  builtinAgentTeamWebTitle: 'Agent Teams Web UI',
  builtinAgentTeamWebDescription: 'Watch the team at work in the browser: see who is busy and who is idle at a glance, follow the task board live, and open any member\'s own session with a click.',
