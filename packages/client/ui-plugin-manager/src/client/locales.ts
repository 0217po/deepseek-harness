...
export const zh = {
  ...
  registryOfficial: '官方源',
  registryOfficialHint: 'registry.npmjs.org，遵循你本机的 pnpm 与 .npmrc 配置',
  registryOwnHint: '本机 pnpm 配置指定的源：{url}',
  registryDefaultTag: '（默认）',
...
export const en = {
  ...
  registryOfficial: 'Official',
  registryOfficialHint: 'registry.npmjs.org, following the pnpm and .npmrc configuration on this machine',
  registryOwnHint: 'The registry the pnpm configuration on this machine names: {url}',
  registryDefaultTag: ' (default)',
  registryNpmmirror: 'npmmirror',
