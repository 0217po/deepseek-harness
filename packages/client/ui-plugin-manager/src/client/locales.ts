...
export const zh = {
  ...
  registryDefault: '默认安装源（{host}）',
  registryNpmmirror: '中国大陆镜像源（registry.npmmirror.com）',
...
export const en = {
  ...
  registryDefault: 'Default registry ({host})',
  registryNpmmirror: 'Mainland China mirror (registry.npmmirror.com)',
