...
export const zh = {
  'view.chat': '对话',
  'message.stepProcess.thinking': '正在思考',
  'message.stepProcess.commands': '正在运行命令',
  'message.stepProcess.read': '正在读取文件',
  'message.stepProcess.edit': '正在编辑文件',
  'message.stepProcess.search': '正在搜索',
  'message.stepProcess.tools': '正在使用工具',
  'message.stepProcess.done': '已完成思考',
  'message.stepProcess.count.commands.one': '运行了 {count} 条命令',
  'message.stepProcess.count.commands.other': '运行了 {count} 条命令',
  'message.stepProcess.count.read.one': '读取了 {count} 个文件',
  'message.stepProcess.count.read.other': '读取了 {count} 个文件',
  'message.stepProcess.count.edit.one': '编辑了 {count} 个文件',
  'message.stepProcess.count.edit.other': '编辑了 {count} 个文件',
  'message.stepProcess.count.search.one': '搜索了 {count} 次',
  'message.stepProcess.count.search.other': '搜索了 {count} 次',
  'message.stepProcess.count.tools.one': '调用了 {count} 次工具',
  'message.stepProcess.count.tools.other': '调用了 {count} 次工具',
  ...
  'message.turnProcess.workedFor': '工作了 {duration}',
...
export const en = {
  ...
  'message.stepProcess.search': 'Searching',
  'message.stepProcess.tools': 'Using tools',
  'message.stepProcess.done': 'Finished thinking',
  'message.stepProcess.count.commands.one': 'Ran {count} command',
  'message.stepProcess.count.commands.other': 'Ran {count} commands',
  'message.stepProcess.count.read.one': 'Read {count} file',
  'message.stepProcess.count.read.other': 'Read {count} files',
  'message.stepProcess.count.edit.one': 'Edited {count} file',
  'message.stepProcess.count.edit.other': 'Edited {count} files',
  'message.stepProcess.count.search.one': 'Performed {count} search',
  'message.stepProcess.count.search.other': 'Performed {count} searches',
  'message.stepProcess.count.tools.one': 'Used {count} tool',
  'message.stepProcess.count.tools.other': 'Used {count} tools',
  'number.groupSeparator': ',',
