...
export const zh = {
  ...
  'message.stepProcess.retrying': '正在重新尝试',
  ...
  'message.stepProcess.done.retrying': '已完成重试',
...
export const en = {
  ...
  'message.stepProcess.retrying': 'Trying again',
  ...
  'message.stepProcess.done.retrying': 'Retry completed',
