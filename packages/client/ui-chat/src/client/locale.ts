...
export const zh = {
  ...
  'chat.deepDivingWithTime': '深度求索中，用时',
  'chat.deepDivingTimeSeparator': '',
  ...
  'message.trigger.subagentDone': '子任务完成',
  'message.trigger.subagentStopped': '子任务已停止',
  'message.trigger.subagentFailed': '子任务失败',
  ...
  'message.trigger.jobDone': '后台任务完成',
  'message.trigger.jobFailed': '后台任务失败',
  'message.trigger.jobStopped': '后台任务已停止',
  'message.trigger.plugin': '插件状态更新',
  'message.trigger.pluginDone': '插件已启动',
  'message.trigger.pluginUpdated': '插件已更新',
  'message.trigger.pluginRejected': '插件启动被拒绝',
  'message.trigger.pluginFailed': '插件启动或更新失败',
  'message.trigger.pluginError': '插件运行异常',
...
export const en = {
  ...
  'chat.deepDivingWithTime': 'Deep diving for',
  'chat.deepDivingTimeSeparator': ' ',
  ...
  'message.trigger.subagentDone': 'Subtask completed',
  'message.trigger.subagentStopped': 'Subtask stopped',
  'message.trigger.subagentFailed': 'Subtask failed',
  ...
  'message.trigger.jobDone': 'Background task completed',
  'message.trigger.jobFailed': 'Background task failed',
  'message.trigger.jobStopped': 'Background task stopped',
  'message.trigger.plugin': 'Plugin status updated',
  'message.trigger.pluginDone': 'Plugin started',
  'message.trigger.pluginUpdated': 'Plugin updated',
  'message.trigger.pluginRejected': 'Plugin activation rejected',
  'message.trigger.pluginFailed': 'Plugin activation failed',
  'message.trigger.pluginError': 'Plugin runtime error',
