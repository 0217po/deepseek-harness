...
| `icons/*`, `FishLogo`, `BrandWordmark`, `ReferenceIconRegular`/`ReferenceIconMedium`, `LinkIconRegular`/`LinkIconMedium` | Glyphs and brand marks, including outline and filled microphone variants. Use `LinkIconMedium` for 14px clickable-link categories and known-site marks. |
