...
| `StateDot` | 10px 槽内的绿色 `done`、琥珀色 `warning`、红色 `error`、滚动条 hover-l1 色的 `idle` 灰点，以及深灰色 14px 旋转 `ongoing` loading。它是 `aria-hidden` 的，名称由渲染点提供。 |
