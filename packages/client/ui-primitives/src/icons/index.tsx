...
const IconNewChatOutlineArtwork = ({ size = 16, className, strokeWidth }: WeightedIconProps) => (
...
export const IconNewChatOutlineRegular = (props: IconProps) => (
  <IconNewChatOutlineArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconNewChatOutline artwork with a 1.3px stroke. */
export const IconNewChatOutlineMedium = (props: IconProps) => (
  <IconNewChatOutlineArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
...
const IconGlobeOutlineArtwork = ({ size = 14, className, strokeWidth }: WeightedIconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" strokeWidth={strokeWidth}>
...
export const IconGlobeOutlineRegular = (props: IconProps) => (
  <IconGlobeOutlineArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconGlobeOutline artwork with a 1.3px stroke. */
export const IconGlobeOutlineMedium = (props: IconProps) => (
  <IconGlobeOutlineArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
...
/** Regular one-pixel IconTriangleRightFill artwork. */
...
/** Medium IconTriangleRightFill artwork with a 1.3px stroke. */
...
const IconBrowseOutlineArtwork = ({ size = 16, className, strokeWidth }: WeightedIconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" strokeWidth={strokeWidth}>
...
export const IconBrowseOutlineRegular = (props: IconProps) => (
  <IconBrowseOutlineArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconBrowseOutline artwork with a 1.3px stroke. */
export const IconBrowseOutlineMedium = (props: IconProps) => (
  <IconBrowseOutlineArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
...
export const IconFolderCloseRegular = (props: IconProps) => (
  <IconFolderCloseArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconFolderClose artwork with a 1.3px stroke. */
export const IconFolderCloseMedium = (props: IconProps) => (
  <IconFolderCloseArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
...
const IconInspectOutlineArtwork = ({ size = 12, className, strokeWidth }: WeightedIconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" strokeWidth={strokeWidth}>
...
export const IconInspectOutlineRegular = (props: IconProps) => (
  <IconInspectOutlineArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconInspectOutline artwork with a 1.3px stroke. */
export const IconInspectOutlineMedium = (props: IconProps) => (
  <IconInspectOutlineArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
