...
/** Agent-team plugin artwork (four interlocking quadrants). */
export const PluginArtworkTeam = ({ size = 36, className }: IconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.3027 17.1077H9.03125V12.8372H13.3027V17.1077ZM17.5742 12.8372C17.574 15.1958 15.6623 17.1075 13.3037 17.1077V8.56567H17.5742V12.8372Z" fill="url(#dsh_plugin_art_team_a)" />
    <path d="M18.5229 12.8372V8.56567H22.7944V12.8372H27.0659V17.1077H22.7944C20.4357 17.1077 18.5232 15.1959 18.5229 12.8372Z" fill="#F2AF63" />
    <path d="M17.5742 26.6072H13.3037V18.0642C15.6625 18.0644 17.5742 19.9769 17.5742 22.3357V26.6072ZM13.3027 22.3357H9.03125V18.0642H13.3027V22.3357Z" fill="#7CB7FF" />
    <path d="M22.7944 26.6072H18.5229V22.3357C18.5229 19.9768 20.4355 18.0642 22.7944 18.0642H27.0659V22.3357H22.7944V26.6072Z" fill="#45D9E7" />
    <defs>
      <linearGradient id="dsh_plugin_art_team_a" x1="16.1247" y1="6.6613" x2="9.03125" y2="19.2206" gradientUnits="userSpaceOnUse">
        <stop stopColor="#7CB7FF" />
        <stop offset="1" stopColor="#145AF3" />
      </linearGradient>
    </defs>
  </svg>
)
...
export const PluginArtworkLoop = ({ size = 36, className }: IconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M18.0486 6.89667C12.0858 6.89667 7.25195 11.7305 7.25195 17.6934C13.2148 17.6934 18.0486 12.8595 18.0486 6.89667Z" fill="url(#dsh_plugin_art_loop_a)" />
    ...
    <defs>
      <linearGradient id="dsh_plugin_art_loop_a" x1="16.7911" y1="16.1655" x2="8.98192" y2="8.74289" gradientUnits="userSpaceOnUse">
...
/** Subagent plugin artwork (two stacked rounded squares); also marks one row inside a bundle. */
export const PluginArtworkSubagent = ({ size = 36, className }: IconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="14.9893" y="15.1877" width="12.2365" height="12.2365" rx="2" fill="url(#dsh_plugin_art_sub_a)" fillOpacity="0.8" />
    <rect x="8.87109" y="9.0697" width="12.2365" height="12.2365" rx="2" fill="url(#dsh_plugin_art_sub_b)" fillOpacity="0.8" />
    <defs>
      <linearGradient id="dsh_plugin_art_sub_a" x1="21.1075" y1="15.1877" x2="21.1075" y2="27.4243" gradientUnits="userSpaceOnUse">
        <stop stopColor="#45E7A4" />
        <stop offset="1" stopColor="#05909D" />
      </linearGradient>
      <linearGradient id="dsh_plugin_art_sub_b" x1="14.9894" y1="9.0697" x2="14.9894" y2="21.3063" gradientUnits="userSpaceOnUse">
...
export const PluginArtworkSearch = ({ size = 36, className }: IconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#dsh_plugin_art_search_ring)">
    ...
    <defs>
      <clipPath id="dsh_plugin_art_search_ring">
