...
export const en = {
  ...
  'timing.intervalHint.minute': 'At least 5 minutes. The interval counts from task creation or the last rule change and is independent of time zones.',
  'timing.intervalHint.second': 'At least 300 seconds. The interval counts from task creation or the last rule change and is independent of time zones.',
  ...
  'timing.invalidInterval': 'Enter an interval of at least 5 minutes.',
  'timing.invalidInterval.hour': 'Enter an interval of at least 1 hour.',
  'timing.invalidInterval.minute': 'Enter an interval of at least 5 minutes.',
  'timing.invalidInterval.second': 'Enter an interval of at least 300 seconds.',
...
export const zh: Record<TaskManagerKey, string> = {
  ...
  'timing.intervalHint.minute': '至少 5 分钟。间隔自任务创建或上次修改规则时起计，不受时区影响',
  'timing.intervalHint.second': '至少 300 秒。间隔自任务创建或上次修改规则时起计，不受时区影响',
  ...
  'timing.invalidInterval': '请输入至少 5 分钟的间隔',
  'timing.invalidInterval.hour': '请输入至少 1 小时的间隔',
  'timing.invalidInterval.minute': '请输入至少 5 分钟的间隔',
  'timing.invalidInterval.second': '请输入至少 300 秒的间隔',
