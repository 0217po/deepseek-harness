...
export const zh = {
  ...
  'setupPrompt.unavailableBody': '请前往语音插件详情页查看识别服务状态并完成准备',
...
export const en: Record<VoiceKey, string> = {
  ...
  'setupPrompt.unavailableBody': 'Open the voice plugin details to check recognition status and finish preparation.',
