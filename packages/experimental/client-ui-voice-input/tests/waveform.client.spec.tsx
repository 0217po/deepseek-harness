...
import type { Recording } from '../src/client/audio.ts'
...
it('samples real levels, throttles drawing, and cancels animation on unmount', () => {
  ...
  const amplitude = vi.fn(() => 0.1)
  const view = render(<Waveform recording={{ amplitude } as unknown as Recording} label="Recording" />)
