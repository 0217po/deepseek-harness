...
Provider plugins own credential-gated discovery. Their catalogs are configured independently; the transport supplies shared default model metadata and capability resolution.
