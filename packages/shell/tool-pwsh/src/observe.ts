/**
 * Record tap for background pwsh runs: copies the spawned process's captured
 ...
 *
 * @module @deepseek-ai/dsh-tool-pwsh/observe
 */

/* jscpd:ignore-start -- mirrors tool-bash's observe tap by design, like render/background. */
