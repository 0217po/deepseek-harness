...
import type { ShellExecRequest, ShellExecSpec, ShellExecution, ShellProcess, ShellProcessRead, ShellPromotionOffer, ShellRunResult, CollectedOutput } from '@deepseek-ai/dsh-shell'
