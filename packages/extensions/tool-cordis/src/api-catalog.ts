  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Install a package using the same pnpm implementation as dsh plugin. GitHub repositories must pass a Git connection check within githubConnectionTimeoutMs before pnpm starts. A run that fails, is cancelled, or adds a package without a bundle patch restores `package.json` and `pnpm-lock.yaml` as they were; downloaded files can stay.',
