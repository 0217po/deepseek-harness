...
| `every_seconds` | `{"prompt":"Check the queue","title":"Queue check","every_seconds":300}` | Fixed safe-integer interval of at least 300 seconds, initially aligned to creation. |
