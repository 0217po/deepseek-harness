...
| [`gateway/`](gateway/README.md) | Carries typed unary calls, multiplexed streams with optional duplex uplinks, and forwarded Host events. | `ctx.typertGateway` / `ctx.remote` |
