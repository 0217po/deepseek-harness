...
Use `plugin:` for migrated extension identifiers and explicitly mapped extension-field names. Preserve complete original names and payloads, distinguish source and field owners to prevent collisions, and leave known core identities and opaque nested data alone. Document each exact mapping in the edge README.
