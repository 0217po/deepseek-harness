...
| `source` | required | [`MessageSource`](#persistence-type-sha256-b1a819c6930a332d1018838361073d9b3e754476e5dd345d479821554446d644) |
...
| `user-question-reply` | not declared | `callId`: `string`; `outcome`: [`union (2 variants)`](#persistence-type-sha256-3e8ed906c20694e13769d14e7f510ea650bc1977d318ad3375eb5e25d75a8dc3) | [`{ kind: "user-question-reply" }`](#persistence-type-sha256-a88baeb50f7e9485fbdc6d4dfaf26d04210be3c699bca84b97a0e2abafc9bd25) |
...
Array of [`Message`](#persistence-type-sha256-453230f850102bbad10d17b227431d749e58d084f8c15a17dd79ce4f100c52ca).
...
| `messageSeqs` | required | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | required | [`Message[]`](#persistence-type-sha256-ad6c4e4a7270450d096793e75298c39ec6f91d5e30f211fb8ff24b72695f8dc1) |
...
Array of [`UserMessage`](#persistence-type-sha256-7865a04b33ddf40314f467043e50388a3b6ba3a8b51de7c4ef61ad9910bafcec).
...
| `message` | required | [`DeveloperMessage`](#persistence-type-sha256-19ac4d9fb655ae9f2d9e8993d083d3eb9aede910d0454b892eb6e1290f55179c) |
| `step` | required | `number` |
| `turn` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `inserted` | required | [`UserMessage[]`](#persistence-type-sha256-94408de87611d1469c83ff7f1a8c6366e4e0ada349ff090c2bd408a024bab080) |
...
| `outcome` | required | [`union (2 variants)`](#persistence-type-sha256-3e8ed906c20694e13769d14e7f510ea650bc1977d318ad3375eb5e25d75a8dc3) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-b7ae3ff2cea93132e51e04be70f73590c91509e32bcaa34f3260d5503cfa0d3c) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-c4d3620755d2defbe487d6e64259886b87b5dcff7bd58c8f9d85a06fa6f9bce0) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | required | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-3e94e9061e5069552df9a5568f90c89bec379a9cdf0dc3c122127746312111e9) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`UserMessage`](#persistence-type-sha256-7865a04b33ddf40314f467043e50388a3b6ba3a8b51de7c4ef61ad9910bafcec) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | required | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
