...
| `event:system/message` | event | `54a8682615a7ffc3e1e3c41ab003ae61082ae2792c57407f5bd8bb38fded3f0e` | [`{ type: "system/message" }`](#persistence-type-sha256-54a8682615a7ffc3e1e3c41ab003ae61082ae2792c57407f5bd8bb38fded3f0e) |
...
Sources: [`packages/core/session/src/types.ts:189`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:79`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:111`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:35`](../packages/session/session-title/src/types.ts)
...
Sources: [`packages/llm/llm/src/message.ts:190`](../packages/llm/llm/src/message.ts)
...
| `code-mode` | not declared | none | [`{ kind: "code-mode" }`](#persistence-type-sha256-b0fdf76590690063dff16e2ba5aa14cb6ed074b61980b3860c299c2e8efc7a1a) |
...
Array of [`Message`](#persistence-type-sha256-cc2968a9a0a95309a7d3218dcb0c55d153fe7b8c03b5648ea6fcc69d91a64a7f).
...
| `messageSeqs` | required | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | required | [`Message[]`](#persistence-type-sha256-531c1bf918d4ce9eeb8a51d32484587bc77a62e5806d8c29e64040fcafd6517e) |
...
<a id="persistence-type-sha256-20a3c1c8a3154e4ae69eada1212e3216baf93454ee4c745565b9374d7539fe8b"></a>
...
SHA-256: `20a3c1c8a3154e4ae69eada1212e3216baf93454ee4c745565b9374d7539fe8b`
...
Sources: [`packages/llm/llm/src/message.ts:168`](../packages/llm/llm/src/message.ts)
...
| `id` | required | `string` |
| `role` | required | `"user"` |
| `source` | required | [`MessageSource`](#persistence-type-sha256-7aae986884b7f69068d9f9d7d77910a0dbe2b265843a041576877eb1bc01f31e) |
...
Array of [`UserMessage`](#persistence-type-sha256-980b8f7c2576a03df48bd09fd68000d88eaec6e99ca5bec36e6448401b8e3e95).
...
| Property | Presence | Type |
|---|---|---|
| `inserted` | required | [`UserMessage[]`](#persistence-type-sha256-fc336025695a2213c63d0fe8715307c6a6ede867713bbf2ab1c8ff9760fdee1f) |
...
Sources: [`packages/core/tools/src/ptc.ts:13`](../packages/core/tools/src/ptc.ts)

| Property | Presence | Type |
|---|---|---|
| `kind` | required | `"code-mode"` |
...
<a id="persistence-type-sha256-0baa4dd6c2795de2454f2a20eadf1116981ae995f61a3e5b8128dcbca76c2048"></a>

### `{ message, step, turn }`

SHA-256: `0baa4dd6c2795de2454f2a20eadf1116981ae995f61a3e5b8128dcbca76c2048`

Sources: [`packages/core/session/src/types.ts:321`](../packages/core/session/src/types.ts)

| Property | Presence | Type |
|---|---|---|
| `message` | required | [`SystemMessage`](#persistence-type-sha256-20a3c1c8a3154e4ae69eada1212e3216baf93454ee4c745565b9374d7539fe8b) |
| `step` | required | `number` |
| `turn` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-37af4fdde18eb8638d5037243e0ee1c617b9b1062ae9dbee086feafad852112f) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-608866d72de8327687e3730cb213d57cf8485012419673de9e5765f4a71f7f2d) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
...
<a id="persistence-type-sha256-54a8682615a7ffc3e1e3c41ab003ae61082ae2792c57407f5bd8bb38fded3f0e"></a>

<a id="persistence-type-eventsystemmessage"></a>

### `{ type: "system/message" }`

SHA-256: `54a8682615a7ffc3e1e3c41ab003ae61082ae2792c57407f5bd8bb38fded3f0e`

| Property | Presence | Type |
|---|---|---|
| `data` | required | [`{ message, step, turn }`](#persistence-type-sha256-0baa4dd6c2795de2454f2a20eadf1116981ae995f61a3e5b8128dcbca76c2048) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | required | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| Property | Presence | Type |
|---|---|---|
| `data` | required | [`UserMessage`](#persistence-type-sha256-980b8f7c2576a03df48bd09fd68000d88eaec6e99ca5bec36e6448401b8e3e95) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `sourceEventSeqs` | optional | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | required | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
