...
| `ctx.pluginInstallLocation` | `core` | [`client-ui-plugin-manager`](../packages/client/ui-plugin-manager) | - | [`client-ui-plugin-manager`](../packages/client/ui-plugin-manager) | - | Shares a bounded country lookup across dialogs; the Client owns the initial registry recommendation. |
