...
flowchart LR
  ...
  svc_pluginInstallLocation["ctx.pluginInstallLocation<br/>Host exit country for plugin installation"]
  ...
  pkg_client_ui_plugin_manager --> svc_pluginInstallLocation
  ...
  svc_pluginInstallLocation --> pkg_client_ui_plugin_manager
...
| `ctx.pluginInstallLocation` | `core` | [`client-ui-plugin-manager`](../packages/client/ui-plugin-manager) | - | [`client-ui-plugin-manager`](../packages/client/ui-plugin-manager) | - | 在对话框之间共享有时限的国家查询；初始安装源推荐由 Client 负责。 |
