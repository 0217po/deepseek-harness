...
- **Dependency ranges.** Renaming changes dependency keys without changing ranges. Workspace manifests use the `workspace:` protocol; [package rules](../packages/AGENTS.md) distinguish exact DSH references from vendored caret ranges.
