...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  JobSnapshot: 'jobs.md',
  JobStart: 'jobs.md',
  PlainJobStart: 'jobs.md',
  RecordingJob: 'jobs.md',
  RecordingJobStart: 'jobs.md',
  JobsChangedListener: 'jobs.md',
  JobAppendOptions: 'jobs.md',
  JobChannel: 'jobs.md',
  JobOutputListener: 'jobs.md',
  JobRecordChunk: 'jobs.md',
  JobRecordRead: 'jobs.md',
  RunningJob: 'jobs.md',
