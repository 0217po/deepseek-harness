- banner:
  - navigation "Session hierarchy": /user-invoke-demo @"this-is-a-very-long-
  - text: Standard mode
  - button "More actions"
...
- button "this-is-a-very-long-filename-for-testing-user-message-file-references-and-preview-layout.md"
