...
export const en = {
  ...
  backgroundNoticeTitle: 'DeepSeek Harness is still running',
  backgroundNoticeBody: 'Running tasks will continue. Reopen or quit it from the system tray.',
  edit: 'Edit',
...
export const zh = {
  ...
  backgroundNoticeTitle: 'DeepSeek Harness 仍在后台运行',
  backgroundNoticeBody: '正在运行的任务不会中断。可在系统托盘中重新打开或退出。',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
