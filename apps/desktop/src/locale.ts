...
export const en = {
  ...
  welcomeTaglineBefore: 'Go deeper with ',
  welcomeTaglineBrand: 'DeepSeek',
  welcomeTaglineAfter: '',
  welcomeAuthStarting: 'Opening sign in…',
  welcomeAuthWaiting: 'Continue in your browser',
  ...
  welcomeAuthReopen: 'Open browser again',
